    ...
    return (
        <div className="w-full mx-auto flex justify-center flex-col lg:my-20 mt-28 md:mt-12 md:px-4">
            ...
            <div className="w-full flex flex-row flex-wrap items-center justify-center mt-4">
                ...
                <img className="w-1/2 rounded" src="https://assets.vogue.com/photos/5de22be4d3d4d50008c2f92e/master/w_2560%2Cc_limit/Alcatraz_JanetDelaney_25.jpg" alt="Native family" />
            </div>
        </div>
    )
};
